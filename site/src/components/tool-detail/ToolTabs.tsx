...
import { TOOL_DETAIL_TABS, type ToolDetailTabId } from "@/data/tool-detail";

type ToolTabsProps = {
  active: ToolDetailTabId;
  onChange: (id: ToolDetailTabId) => void;
};
...
export function ToolTabs({ active, onChange }: ToolTabsProps) {
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="flex min-w-max gap-1" role="tablist" aria-label="بخش‌های ابزار">
