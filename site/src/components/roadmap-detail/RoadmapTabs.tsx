...
import { ROADMAP_DETAIL_TABS, type RoadmapDetailTabId } from "@/data/roadmap-detail";

type RoadmapTabsProps = {
  active: RoadmapDetailTabId;
  onChange: (id: RoadmapDetailTabId) => void;
};
...
export function RoadmapTabs({ active, onChange }: RoadmapTabsProps) {
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="flex min-w-max gap-1" role="tablist" aria-label="بخش‌های نقشه راه">
        {ROADMAP_DETAIL_TABS.map((tab) => {
